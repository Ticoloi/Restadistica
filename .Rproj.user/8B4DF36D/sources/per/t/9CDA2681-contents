...
ggplot(taula_poblacio_plot, aes(x = Any, y = Població_total)) +
  ...
  labs(title = "Població total per any (Totes les comarques)", x = "Any", y = "Població (persones)") +
...
ggplot(total_sobre_domestic, aes(x = Any, y = resultat)) +
  geom_line(color = "darkblue", linewidth = 1.2) +
  geom_point(color = "darkblue", size = 3) +
  labs(title = "Consum_doméstic / Consum_total", x = "Any", y = "Consum_doméstic / Consum_total") +
  scale_x_continuous(breaks = unique(taula_poblacio_plot$Any)) +
  scale_y_continuous(labels = scales::comma, limits = c(0, NA)) +
  theme_minimal() +
  theme(
...
ggplot(total_sobre_domestic, aes(x = Any, y = resultat)) +
  geom_line(color = "darkblue", linewidth = 1.2) +
  geom_point(color = "darkblue", size = 3) +
  labs(title = "Poblacio / Consum_total", x = "Any", y = "Poblacio / Consum_total") +
  scale_x_continuous(breaks = unique(taula_poblacio_plot$Any)) +
  scale_y_continuous(labels = scales::comma, limits = c(0, NA)) +
  theme_minimal() +
  theme(
...
# Gràfic amb totes les regions al mateix plot
ggplot(taula_resultat_completa,
       aes(
         x = Any,
         y = Consum_per_capita,
         color = Regio,
